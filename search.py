...
def uniformCostSearch(problem):
    ...
    successors = problem.getSuccessors(problem.getStartState())
    for s in successors:
        nodes.push((s[0], [s[1]]), problem.getCostOfActions([s[1]]))
    ...
    while(not nodes.isEmpty()):
        ...
        for s in successors:
            ...
            nodes.push((s[0], newPath), problem.getCostOfActions(newPath))
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    successors = problem.getSuccessors(problem.getStartState())
    for s in successors:
        nodes.push((s[0], [s[1]]), problem.getCostOfActions([s[1]]) + heuristic(s[0], problem) )
    ...
    while(not nodes.isEmpty()):
        ...
        for s in successors:
            ...
            nodes.push((s[0], newPath), problem.getCostOfActions(newPath) + heuristic(s[0], problem))
